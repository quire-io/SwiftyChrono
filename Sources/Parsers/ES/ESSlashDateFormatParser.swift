...
//        let startIdx = fullMatchText.index(fullMatchText.startIndex, offsetBy: openGroup.count)
//        let endIDx = fullMatchText.count - endGroup.count
//        let range = startIdx..<endIDx
//        let subStr = fullMatchText[range]
//        let matchText = String(subStr)
