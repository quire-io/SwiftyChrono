...
public class ZHHantDateParser: Parser {
    ...
    override public func extract(text: String, ref: Date, match: NSTextCheckingResult, opt: [OptionType: Int]) -> ParsedResult? {
        ...
        let month = NSRegularExpression.isMatch(forPattern: "\\d+", in: monthString) ? ZHStringToNumber(text: monthString) : Int(monthString)
        ...
        if match.isNotEmpty(atRangeIndex: dayGroup) {
            ...
            let day = NSRegularExpression.isMatch(forPattern: "\\d+", in: dayString) ? ZHStringToNumber(text: dayString) : Int(dayString)
        ...
        if match.isNotEmpty(atRangeIndex: yearGroup) {
            ...
            let year = NSRegularExpression.isMatch(forPattern: "\\d+", in: yearString) ? ZHStringToNumber(text: yearString) : Int(yearString)
