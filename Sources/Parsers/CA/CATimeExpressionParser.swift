//
//  CATimeExpressionParser.swift
//  SwiftyChrono
//
//  Translated from ESTimeExpressionParser.swift.
...
public class CATimeExpressionParser: Parser {
    ...
    override public func extract(text: String, ref: Date, match: NSTextCheckingResult, opt: [OptionType: Int]) -> ParsedResult? {
        ...
        result.tags[.caTimeExpressionParser] = true
        ...
        if NSRegularExpression.isMatch(forPattern: "migdia", in: hourText) {
            meridiem = 1
            hour = 12
        } else if hourText == "mitjanit" {
            meridiem = 0
            hour = 0
        } else {
            hour = Int(hourText)!
