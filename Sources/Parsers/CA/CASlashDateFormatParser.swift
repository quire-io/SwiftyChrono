//
//  CASlashDateFormatParser.swift
//  SwiftyChrono
//
//  Translated from ESSlashDateFormatParser.swift.
...
public class CASlashDateFormatParser: Parser {
    ...
    override public func extract(text: String, ref: Date, match: NSTextCheckingResult, opt: [OptionType: Int]) -> ParsedResult? {
        ...
        if match.isNotEmpty(atRangeIndex: weekdayGroup) {
            ...
            result.start.assign(.weekday, value: CA_WEEKDAY_OFFSET[weekday])
        }
        
        result.tags[.caSlashDateFormatParser] = true
        return result
    }
}
